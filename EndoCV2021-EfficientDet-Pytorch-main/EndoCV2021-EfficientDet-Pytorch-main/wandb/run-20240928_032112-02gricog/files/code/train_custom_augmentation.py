...
if enable_wandb:
    wandb.init(project="kvasir2024", entity="chaupnm-22bi13063", save_code=True)
...
def get_mAP(opt, set_type="val_set"):
    ...
    VAL_GT = f'C:/Users/Chou/CODE/dl_project/kvasir-seg/Kvasir-SEG/train/CV_folds/{params["project_name"]}/annotations/instances_{SET_NAME}.json'
    VAL_IMGS = f'C:/Users/Chou/CODE/dl_project/kvasir-seg/Kvasir-SEG/train/CV_folds/{params["project_name"]}/{SET_NAME}/'
    MAX_IMAGES = 10000
    coco_gt = COCO(VAL_GT)
...
def train(opt):
    ...
    input_sizes = [512, 640, 768, 896, 1024, 1280, 1280, 1536, 1536]
    training_set = CocoDataset(root_dir=os.path.join(r'C:/Users/Chou/CODE/dl_project/kvasir-seg/Kvasir-SEG/train/CV_folds', params.project_name), set=params.train_set,
